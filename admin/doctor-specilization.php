...
$_SESSION['msg']="Doctor Specialization added successfully !!";
 header("Refresh: 2; URL=doctor-specilization.php");
}
//Code Deletion
if(isset($_GET['del']))
{
			...
			<div class="app-content">
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						<!-- start: PAGE TITLE -->
						<section id="page-title" style="background-color: aquamarine;">
							<div class="row">
								<div class="col-sm-8">
						...
						<!-- end: PAGE TITLE -->
						<!-- start: BASIC EXAMPLE -->
						<div class="container-fluid container-fullw "  style="background-color: #b6edd1;">
							<div class="row">
								<div class="col-md-12" >
